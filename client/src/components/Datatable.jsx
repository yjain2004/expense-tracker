...
function Datatable() {
    ...
    return (
        <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 rounded-2xl mt-4">
            <div class="">
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4 w-full">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    <th scope="col" class="px-4 py-3">Transaction title</th>
                            ...
                            <tbody>
                                ...
                                {data && data.map((item) => {
                                    return <tr class="border-b dark:border-gray-700" key={item._id}>
                    ...
                    {data == null && (
                        <div className='w-full text-center p-4 text-white'>No Entries</div>

                    )}
                    {data && (
                        <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4" aria-label="Table navigation">

                            <ul class="inline-flex items-stretch -space-x-px mx-auto">
                                <li>
