        ...
        <section className="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 rounded-2xl mt-4">
            <div className="">
                <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    ...
                    {data == null && (
                        <div className='w-full text-center p-4 text-white text-3xl flex items-center flex-col p-32'>
                            <svg className="w-[50px] h-[50px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
